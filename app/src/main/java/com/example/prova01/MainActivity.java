...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Sobremesa>> call = service.buscaSobremesas();

        call.enqueue(new Callback<List<Sobremesa>>() {
            @Override
            ...
            @Override
            public void onFailure(Call<List<Sobremesa>> call, Throwable throwable) {
